...
db.LCItems.updateOne({ itemId: "AEHM01" }, {
  $set: {
    "optionBullets": [
      "Under 18 years",
      "18-24 years",
...
db.LCItems.updateOne({ itemId: "RV07" }, {
  $set: {
    "statement": "The key to a happy relationship is to let go of your expectations that are not met."
  }
})
db.LCItems.updateOne({ itemId: "MV02" }, {
  $set: {
    "statement": "Premarital counselling is mainly for couples who have issues."
  }
});

db.LCItems.updateOne({ itemId: "MV06" }, {
  $set: {
    "statement": "It's okay to take a few months to find a groove with your partner in bed."
  }
})
...
db.LIItems.updateOne({ itemId: "CS02" }, {
  $set: {
    "optionBullets": [
      "Yes",
      "No",
